...
export const metadata:Metadata = {
  ...
  description: 'FlexShopper provides a flexible and easy way for you to lease-to-own the furniture, electronics, appliances and other popular brand name goods with affordable, weekly payments.',
  keywords: 'flexshopper, rent to own, lease to own, weekly payments, rent, used, new, special offers, deals',
  icons:[
    { rel: "icon", url: "https://www.flexshopper.com/img/favicon.ico" },
    { rel: "shortcut icon", url: "https://www.flexshopper.com/img/favicon.ico" },
